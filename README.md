...
This is a document of my process setting up k3s from scratch and all the needs to have a working kubernetes station running on a Raspberry Pi with automated updates for your apps directly from a git push.

> [!IMPORTANT]
> This is my first kubernetes project.<br>Some configurations may not strictly follow industry best practices.
...
These are the exact materials i made this setup work, they can vary in your case:
